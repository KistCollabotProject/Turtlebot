...
class stool:
    ...
    def callback1(self, msg):
        ...
        if msg.data == "sceinaro 1": #child 이고 최상단을 뽑음
            if self.bookcase == "book 1":
                stool.turtlebot3_move=True   
                self.movebase_client(0,0,0) # book 1의 좌표
                stool.turtlebot3_move=False
            elif self.bookcase == "book 2" :
                stool.turtlebot3_move=True   
                self.movebase_client(0,0,0) # book 2의 좌표
                stool.turtlebot3_move=False
            elif self.bookcase == "book 3":
                stool.turtlebot3_move=True   
                self.movebase_client(0,0,0) # book 3의 좌표
                stool.turtlebot3_move=False
            else:
            ...
            if self.bookcase == "book 1" or self.bookcase == "book 4" or self.bookcase == "book 7":
                stool.turtlebot3_move=True   
                self.movebase_client(0,0,0) # book 1,4,7의 좌표
                stool.turtlebot3_move=False
            elif self.bookcase == "book 2" or self.bookcase == "book 5"  or self.bookcase == "book 8":
                stool.turtlebot3_move=True   
                self.movebase_client(0,0,0) # book 2,5,8의 좌표
                stool.turtlebot3_move=False
            elif self.bookcase == "book 3" or self.bookcase == "book 6" or self.bookcase == "book 9":
                stool.turtlebot3_move=True   
